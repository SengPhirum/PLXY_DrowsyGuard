...
<figure class="dg-hero__visual" markdown>

![Illustration of DrowsyGuard monitoring a driver's face with an in-vehicle camera and ESP32-S3 edge AI](assets/images/drowsy-guard-cover.webp){ width="1280" height="720" loading=eager fetchpriority=high }

<figcaption markdown="span">Private, offline detection with a local audio alert.</figcaption>
